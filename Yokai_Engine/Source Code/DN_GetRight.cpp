...
DN_GetRight::DN_GetRight(ImVec2 pos, BluePrint* bp, int ask_pin_id, int send_pin_id, std::string go_UUID) : BP_Node("Get Right", BP_Node::TYPE::SIMPLE, pos, ImColor(0, 125, 125), bp)
{
